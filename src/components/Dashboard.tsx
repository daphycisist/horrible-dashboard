	...
	return (
		<div style={{padding: '20px'}}>
			...
			<div className="data-grid" style={{marginBottom: '20px'}}>
				<div className="metric-card" style={{background: '#ff6b6b', color: 'white'}}>
					<h3>Portfolio Value</h3>
					<h2>{formatCurrency(1234567.89)}</h2>
				</div>
				<div className="metric-card" style={{background: '#4ecdc4', color: 'white'}}>
					<h3>Total Returns</h3>
					<h2>{formatCurrency(123456)}</h2>
				</div>
				<div className="metric-card" style={{background: '#45b7d1', color: 'white'}}>
					<h3>Active Trades</h3>
					<h2>247</h2>
				</div>
				<div className="metric-card" style={{background: '#96ceb4', color: 'white'}}>
					<h3>Risk Score</h3>
					<h2>{riskScore}/10</h2>
				</div>
			</div>
